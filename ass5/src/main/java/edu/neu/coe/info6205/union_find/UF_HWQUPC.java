...
/*Using your implementation of UF_HWQUPC, develop a UF ("union-find") client
that takes an integer value n from the command line to determine the number of "sites."
...
Package your program as a static method count() that takes n as the argument
and returns the number of connections; and a main() that takes n from the command line,
calls count() and prints the returned value.*/
    ...
    public static void main(String[] args){
        ...
        System.out.println("sites " + n + ", connection number is" + count(n));

        //not require inputs
        for(n=100001 ; n>=1 ; n=n-5000){
            double sum = 0;
            for(int i=100 ; i>0 ; i--){sum = sum + count(n);}
            double m = sum / 100;//average result of 100 times
            System.out.println("sites " + n + ", connection number is " + m);
        }
    }
}
